...
//rele y sensor ultrasonico
//int RELE = 27;
int TRIG = 25;      // trigger en pin 10
int ECO = 33;      // echo en pin 9
...
const char *mqtt_broker = "18.230.184.146";
...
void loop() {
  ...
  if (tiempo - tdhtx > 200) { //Envia cada 2 segundos
    tdhtx = tiempo;
